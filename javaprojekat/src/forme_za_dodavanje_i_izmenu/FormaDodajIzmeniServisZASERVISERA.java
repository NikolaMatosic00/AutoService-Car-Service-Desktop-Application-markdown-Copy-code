...
public class FormaDodajIzmeniServisZASERVISERA extends JFrame {
...
private Serviser serviiser;
public FormaDodajIzmeniServisZASERVISERA(UcitajIzFajla uf, Servis ser, Serviser s) {
	this.uf = uf;
	this.serviiser = s;
	this.servis = ser;
	if(servis == null) {
...
private void InitActions() {
	...
	btnCancel.addActionListener(new ActionListener() {
		...
		public void actionPerformed(ActionEvent e) {
			...
			FormaDodajIzmeniServisZASERVISERA.this.dispose();
			FormaDodajIzmeniServisZASERVISERA.this.setVisible(false);
