...
public class FormaDodajIzmeniServisera extends JFrame {
	...
	public FormaDodajIzmeniServisera(UcitajIzFajla uf, Serviser ser) {
		this.uf = uf;
		this.serviser = ser;
		if(serviser == null) {
	...
	private void InitActions() {
		btnCancel.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				FormaDodajIzmeniServisera.this.dispose();
				FormaDodajIzmeniServisera.this.setVisible(false);
		...
		btnOK.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				if(validacija()) {
					...
					if(serviser == null) {
						if(uf.NadjiServisera(idd) == null && uf.NadjiServisera(korisnicko_i) == null) {
	...
	private void popuniPolja() {
		id.setText(String.valueOf(serviser.getId()));
