...
public class AFormaMusterija extends JFrame {
...
public AFormaMusterija(SveListe sv, Musterija mus) {
	this.sv = sv;
	this.musterija = mus;
	if(musterija == null) {
...
private void InitActions() {
	...
	btnCancel.addActionListener(new ActionListener() {
		...
		public void actionPerformed(ActionEvent e) {
			...
			AFormaMusterija.this.dispose();
			AFormaMusterija.this.setVisible(false);
	...
	btnOK.addActionListener(new ActionListener() {
		...
		public void actionPerformed(ActionEvent e) {
			if(validacija()) {
				int idd = sv.getMusterije().get(sv.getMusterije().size() - 1).getId() + 1;
				...
				if(musterija == null) {
					if(sv.NadjiMusteriju(idd) == null && sv.NadjiMusteriju(korisnicko_i) == null) {
