...
public class MFormaServis extends JFrame {
...
public MFormaServis(SveListe sv, Servis ser, Musterija musterija) {
	this.sv = sv;
	this.servis = ser;
...
private void InitGUI() {
	...
	for(Serviser s : sv.getServiseri()) {
		serviser.addItem(String.valueOf(s.getId()) + "-" + s.getSpecijalizacija().toString());
	}
...
private void InitActions() {
	...
	btnCancel.addActionListener(new ActionListener() {
		...
		public void actionPerformed(ActionEvent e) {
			...
			MFormaServis.this.dispose();
			MFormaServis.this.setVisible(false);
	...
	btnOK.addActionListener(new ActionListener() {
		...
		public void actionPerformed(ActionEvent e) {
			if(validacija()) {
				...
				int id_servisera = Integer.parseInt(serviser.getSelectedItem().toString().split("-")[0]);
				Serviser servonja = sv.NadjiServisera(id_servisera);
...
private void popuniPolja() {
	...
	serviser.setSelectedItem(servis.getServiser().getId() + "-" + servis.getServiser().getSpecijalizacija().toString());
